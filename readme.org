...
* Things to do
 - [ ] Allow selection of a region to define compound phrases like "personal pronoun".
 ...
 - [ ] Make the code not stink.
   - [ ] Fix global cache usage to at least "oed-cache"
   - [ ] De-factorise the two request calls into one fn
   - [ ] Add proper comments to everything
 - [ ] Remove the "Raw" section from output, or at least make it minimised by default.
